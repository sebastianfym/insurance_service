...
class UserUtilitiesService:
    ...
    async def get_user_by_refresh_token(self, user_repository: UserRepository, refresh_token: str) -> User:
        try:
    ...
    async def refresh_token(self, refresh_token: str):
        ...
        user = await self.get_user_by_refresh_token(user_repository, approve_refresh_token)
